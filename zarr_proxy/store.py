...
def get_zmetadata(
    host: str, path: str, chunks: typing.Union[list[str], None] = Header(default=None)
) -> dict:
...
def get_chunk(
    ...
    try:
        ...
        if settings.zarr_proxy_payload_size_limit and (
            size > settings.zarr_proxy_payload_size_limit
        ):
